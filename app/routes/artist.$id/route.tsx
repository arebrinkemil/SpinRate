      ...
      <div className='m-4 flex flex-col justify-between md:m-8'>
          ...
          {targetData.albums.map((album: any) => (
            ...
            >
              <div className='md:my-4'>
                <li className='hover:bg-lightsilver flex flex-row items-center justify-between  '>
        ...
        <div className='flex flex-col md:hidden'>
          ...
          {targetData.albums.map((album: any) => (
            ...
            >
              <div className='md:my-4'>
                <li className='hover:bg-lightsilver flex flex-row items-center justify-between md:mx-4'>
                  <Link to={`/album/${album.id}`}>
                    <h3>{album.name}</h3>
                  </Link>
                  <img
